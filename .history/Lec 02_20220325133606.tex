...
\subsection{Step 1. Define what the elements of $F$ are to be.}
$D$ is the given integral domain, $S=\{(a,b)|a,b\in D,b\neq 0\}<D\times D$
\subsubsection{Def: equivalent relation $(a,b)\sim(c,d) \Leftrightarrow	$}
\begin{definition}
...
\subsection{Step 2. Define the binary operations of addition and multiplication on F.}
The relation $\sim$ can define a set of all equvalence classes on $[(a,b)], (a,b)\in S$.
\subsubsection{lemma: well-defined equvalence classes}
\begin{lemma}
