...
\end{enumerate}
\end{proof}
\textbf{Note}: This corollary contains the defintion because kernel is normal subgroup. (We can then prove they are exactly the same in the next theorem)


\subsubsection{Theorem: every normal subgroup can be a kernel of a surjective homomorphism}
