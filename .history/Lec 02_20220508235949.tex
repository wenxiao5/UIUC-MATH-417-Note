...
\begin{enumerate}[1)]
    \item \textbf{First Sylow Theorem:} If $G$ is a finite group of order $p^\alpha m$, $gcd(p,m)=1$, then it conatins a subgroup $H$ of order $p^\alpha$. $H$ is called a Sylow $p-$subgroup.
\end{enumerate}
