...
\subsection{Thm: Homomorphism $\phi:R \rightarrow R/H$; Isomorphism: $\mu: R/H \rightarrow	\phi(R)$}
\begin{theorem}
...
\begin{definition}
    $N< R$ is \textbf{ideal} $aN\subseteq N$ and $Nb\subseteq N$ $\forall a,b\in R$
\end{definition}
