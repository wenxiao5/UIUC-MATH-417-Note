...
\subsubsection{$\left\langle a^v\right\rangle<\left\langle a^n\right\rangle$ $\Rightarrow$ $\left\langle a^v\right\rangle=\left\langle a^d\right\rangle, d=gcd(v,n), |\left\langle a^v\right\rangle|=\frac{n}{d}$}
\begin{theorem}
