...
\subsection{Def: }
\begin{definition}
    A proper ideal $M\subsetneq R$ is called \textbf{maximal} if $M\subseteq I\subseteq R \Rightarrow$ $M=I$ or $I=R$ (for $R-$ideal I). i.e, there is no other ideal properly containing $M$.
\end{definition}
