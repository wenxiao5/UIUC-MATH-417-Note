...
A group $G$ is \underline{cyclic} if exists $g$, $\left\langle g\right\rangle=G$.
...
\subsubsection{\underline{Cyclic Subgroup} generated by $a$ (A element)}
If $A = \{a\}$, then $\left\langle a\right\rangle=\left\langle A\right\rangle=\left\langle \{a\}\right\rangle$ is the \underline{cyclic subgroup} generated by $a$.

Easy to prove
$$\left\langle a\right\rangle =\{...a^{-2},a^{-1},e,a^1,a^2...\}$$


\subsubsection{A Subgroup of a Cyclic Group is Cyclic}
\begin{theorem}
A subgroup of a cyclic group is cyclic.
\end{theorem}
\begin{proof}
\quad\\
Let $G=\{a^n:n\in \mathbb{Z}\}$ be a cyclic group.
\end{proof}
