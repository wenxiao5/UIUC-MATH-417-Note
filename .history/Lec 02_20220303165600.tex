...
\begin{theorem}[The Fundamental Homomorphism Theorem]
    \quad
    \begin{center}
        \fcolorbox{black}{gray!10}{\parbox{.9\linewidth}{\underline{Homomorphism $\phi$} can be \textbf{factored} $$\phi=\mu\gamma$$ where $\gamma: G \rightarrow G/H$ is a \underline{homomorphism}, $\mu : G/H \rightarrow	\phi[G]$ is an \underline{isomorphism}}}
    \end{center}
...
\end{theorem}
\begin{proof}
i.e. prove $\mu$ is (1) well-deifined, (2) bijective, (3)homomorphism.
\begin{enumerate}[(1)]
    \item well-defined: if $aH=bH$, then $a^{-1}b\in H$, $$\mu(bH)=\mu((a(a^{-1}b))H)=\phi(a(a^{-1}b))=\phi(a)\phi(a^{-1}b)=\phi(a)=\mu(aH)$$
    \item 
\end{enumerate}
\end{proof}
