...
If $A = \{a\}$, then $\left\langle a\right\rangle=\left\langle A\right\rangle=\left\langle \{a\}\right\rangle$



$\left\langle a\right\rangle =\{...a^{-2},a^{-1},e,a^1,a^2...\}$ is the \underline{cyclic subgroup} generated by $a$.
