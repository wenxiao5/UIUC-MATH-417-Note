...
If $f$ is also a bijection, then $f$ is called an \textbf{isomorphism}. We say that $G$ and $H$ are \textbf{isomorphic}, denoted by $G\cong H$. (since $f$ is bijection, $G\cong H\Leftrightarrow H\cong G$)
\end{definition}
