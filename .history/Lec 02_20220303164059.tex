...
\begin{theorem}[The Fundamental Homomorphism Theorem]
    \quad
    \begin{center}
        \fcolorbox{black}{gray!10}{\parbox{.9\linewidth}{Homomorphism $\phi$ can be \textbf{factored} $$\phi=\mu\gamma$$ where $\gamma: G \rightarrow G/H$ is a homomorphism, $\mu : G/H \rightarrow	\phi[G]$ is an isomorphism}}
    \end{center}
