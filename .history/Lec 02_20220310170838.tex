...
\end{enumerate}
\end{proof}
\textbf{Note}: This corollary contains the defintion because kernel is normal subgroup.


\subsubsection{Theorem: For any normal $H\lhd G$, we can define $\gamma(x)=xH$ which is surjective with $ker \gamma=H$}
\begin{theorem}
