...
\begin{enumerate}
    ...
    If degree of $g(x)\geq 1$, then for all $f(x)\in N$, $\exists q(x),r(x)$ s.t. $f(x)=g(x)q(x)+r(x)$, where $r(x)=0$ or degree $r(x)$< degree $g(x)$. Since $g(x)$ has minimal degree, $r(x)=0 \Rightarrow f(x)=g(x)q(x) \Rightarrow $
\end{enumerate}
\end{proof}
