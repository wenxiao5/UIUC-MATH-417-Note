...
\begin{enumerate}
    ...
    \item If $N\neq\{0\}$, and let $g(x)$ be a nonzero element of $N$ of minimal degree. If $g(x)$ is constant (degree $0$), then $g(x)\in F$ is a unit $\Rightarrow N=\left\langle 1\right\rangle=F[x]$
\end{enumerate}
\end{proof}
