...
\end{proof}
\subsubsection{Cor: If $a\in \mathbb{Z}$, then $a^p\equiv a \text{ mod }p$ for any prime $p$}

\subsubsection{Def: Euler phi function $\phi(n)=|G_n|$, where $G_n=\{a\in \mathbb{Z}_n: gcd(a,n)=1\}$}
