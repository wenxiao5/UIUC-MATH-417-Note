...
\subsubsection{Definition}
\begin{definition}
    The group $G/H=\{aH:a\in G\}$is the factor group (or quotient group) of
    $G$ by $H$.
\end{definition}
\begin{definition}
...
\begin{theorem}
Let $H \lhd G$ be a normal subgroup of $G$. Define $\gamma: G \rightarrow G/H$. Then $\gamma$ is a surjective Homomorphism with $ker \gamma=H$.
\end{theorem}
