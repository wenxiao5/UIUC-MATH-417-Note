...
\subsubsection{Definition}
\begin{definition}
    Let $\phi: G \rightarrow G'$ be a homomorphism of groups with kernel $H$. Then the cosets of $H$ form
    a \textbf{factor group}, $G/H$. where $(aH)(bH) = (ab)H$.
\end{definition}
...
\subsubsection{Well-defined Left Cosets Multiplication}
\begin{theorem}
