...
\begin{theorem}[The Fundamental Homomorphism Theorem]
    \quad
    \begin{center}
        \fcolorbox{black}{gray!10}{\parbox{.9\linewidth}{\underline{Homomorphism $\phi: G \rightarrow G'$ with kernel $H$} can be \textbf{factored} $$\phi=\mu\gamma$$ where $\gamma: G \rightarrow G/H$ is a \underline{homomorphism}, $\mu : G/H \rightarrow	\phi[G]$ is an \underline{isomorphism}\\where $\gamma(g)=gH$ and $\mu(gH)=\phi(g)$}}
    \end{center}
